    ...
    <div className="mx-auto max-w-5xl px-4 py-16">
      <div className="flex items-center gap-3">
        <Badge variant="secondary" className="gap-1">
          <Lightbulb className="h-3 w-3" /> Suport
        </Badge>
        <Badge variant="outline">Actualizat 2026</Badge>
      </div>
      ...
      <section className="mt-12">
        ...
        <div className="mt-6 grid gap-5 md:grid-cols-2">
          {issues.map((i) => {
            const Icon = i.icon;
            return (
              <Card key={i.problem} className="overflow-hidden">
                ...
                <CardContent className="space-y-4 pt-5 text-sm">
                  ...
                  <div className="border-primary/20 bg-primary/5 rounded-md border p-3">
                    ...
                    <p className="text-muted-foreground mt-1">{i.prevention}</p>
                  </div>
                </CardContent>
              </Card>
            );
