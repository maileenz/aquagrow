...
export const cycle = [
    { icon: Fish, title: "1. Peștii", desc: "Hrăniți zilnic, peștii produc deșeuri organice (amoniac) în apa acvariului." },
    ...
    { icon: Sprout, title: "3. Plantele", desc: "Rădăcinile absorb nitrații, curățând apa care se întoarce limpede în acvariu." },
];
export const components = [
    { icon: Leaf, title: "Suport plante", desc: "Construit din material rezistent la apă, se fixează ușor pe marginea acvariului." },
    { icon: Sprout, title: "Substrat dublu", desc: "Turbă pentru germinare, argilă expandată pentru dezvoltare și recoltă." },
];
...
export const values = [
    { icon: Target, title: "Misiune", desc: "Aducem agricultura naturală în fiecare apartament din România." },
    { icon: Users, title: "Comunitate", desc: "Peste 1.500 de oameni cresc deja plante cu AquaVerde." },
    { icon: Lightbulb, title: "Educație", desc: "Ghiduri detaliate, calendare și suport pentru fiecare client." },
];
export const faqs = [
    { q: "Acvaponia e potrivită pentru începători?", a: "Da. Sistemul AquaVerde a fost gândit special pentru oameni fără experiență. Ai nevoie doar de un acvariu cu pești și kitul nostru." },
