    ...
    stages: [
      ...
      },
      {
        ...
        tips: [
          ...
          "Verifică temperatura apei (min. 24°C)",
        ],
    ...
    stages: [
      {
        ...
        from: 1,
        to: 7,
        action: "Ține semințele la cald (24-25°C), turba ușor umedă.",
        tips: [
          "Pune semințele la suprafață, acoperă ușor cu turbă",
          "Temperatura ESTE critică — minim 24°C",
